			...
			this.each(function() {
			 ...
			 $(this).attr('data-tagsinput-init', true);
				...
				$( "#"+id+'_tagsinput' ).on( "click", ".insert", function( event ) {
					$('#'+id+'_tagsinput .tag').popover('destroy');
					...
					$('#insertFm #new-equipment-container').removeClass('has-error'); 
					...
					$('#insertFm #new-equipment-value').bind('keyup',data,function(event) {
						...
						if (tags_callbacks[id]['beforeAddTag']) {
						 ...
						 if (tags_callbacks[id]['checkValidity']) {
								...
								if( validationError != '') {
									$('#insertFm #new-equipment-container').addClass('has-error'); 
				...
				$( "#"+id+'_tagsinput' ).on( "click", ".text", function( event ) {
					...
					$('#saveFm  #new-equipment-container').removeClass('has-error'); 
					...
					$('#saveFm  #save-edit').prop("disabled",true);
					 ...
					 if (tags_callbacks[id]['checkValidity']) {
							...
							if (!(validationError == '') ) {
								$('#saveFm #new-equipment-container').addClass('has-error'); 
